...
GAME_MESSAGE = "⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب sezar\n\n⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('sezar sezar', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝⚡️', url =f"https://t.me/UIU_II")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب sezar 3D\n\n⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺"
             ...
             GAME1_BUTTONS = [
                 [
                    ...
                    InlineKeyboardButton (
                        "°القط المجنون°" , url=f"http://t.me/gamee?game=sezarazyCat"),
                ],[
                    InlineKeyboardButton (
                        "◁" , callback_data= 'GAME')
                  ],
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب sezar\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب sezar', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝⚡️', url =f"https://t.me/UIU_II")              
                 ],[
                InlineKeyboardButton(
               ...
               SOURCE_GAME = "⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺\n\n★¦العاب sezar\n★¦كت\n★¦تويت\n★¦اسال\n★¦اصراحه\n\n⩹━★⊷━⌞ ᥉ًٰٖ᥆ُᥙٰٓᖇٰᥴٍᥱٍُٰ ᥉ُِٰᥱُْٰᤁُᥲُِᖇٖ ⌝━⊶★━⩺." 
